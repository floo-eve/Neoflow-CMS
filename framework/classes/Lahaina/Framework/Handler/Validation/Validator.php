...
/**
     ...
     */
    public function callback($callback, $message = '', $callbackArgs = array())
    {
    ...
    public function set($key, $label = '')
    {
        ...
        $this->labels[$key] = $this->getTranslator()->translate($label, array(), false);
    ...
    public function validate()
    {
        ...
        if ($this->hasErrors()) {
            $this->app()->get('session')
                ->setFlash('validationErrors', $this->getAllErrors())
                ->setFlash('validationData', $this->data);
    ...
    protected function registerError($rule, $key, $message = '')
    {
        ...
        $this->errors[$key] = $this->getTranslator()->translate($message, $values);
    }
    ...
    protected function setRule($rule, $function, $message = '', $args = array())
    {
        ...
        if (!isset($this->rules[$rule])) {
            ...
            if (is_callable($function)) {
                ...
                throw new \InvalidArgumentException('Invalid function for rule: ' . $rule);
            }
        }
    }
