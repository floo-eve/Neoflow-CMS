...
trait RuleTrait
{
    ...
    public function between($minLimit, $maxLimit, $message = '')
    {
        ...
        }, $message, array($minLimit, $maxLimit));
    ...
    public function betweenLength($minLength, $maxLength, $message = '')
    {
        ...
        }, $message, array($minLength, $maxLength));
    ...
    public function matches($key, $label, $message = '')
    {
        $this->setRule(__FUNCTION__, function ($value, $args) {
            ...
            return $value === $match;
        }, $message, array($label, $this->get($key)));
    ...
    public function endsWith($sub, $message = '')
    {
        $this->setRule(__FUNCTION__, function ($value, $args) {
            ...
            return strpos($value, $sub) === strlen($value) - strlen($sub);
        }, $message, array($sub));
    ...
    {
        $this->setRule(__FUNCTION__, function ($value, $args) {
            return (bool) DateTime::createFromFormat($this->getTranslator()->getDateFormat(), $value);
        }, $message, array(new \DateTime('now')));
    ...
    public function minDate($limitDate, $limitDateFormat, $message = '')
    {
        ...
        $this->setRule(__FUNCTION__, function ($value, $args) {
            ...
            $limitDate = $args[0];
            $value = DateTime::createFromFormat($this->getTranslator()->getDateFormat(), $value);

            return $value && $limitDate <= $value;
        }, $message, array($limitDate));
